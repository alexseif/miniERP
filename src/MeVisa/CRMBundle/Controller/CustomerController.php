...
use MeVisa\CRMBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MeVisaCRMBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("MeVisaCRMBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MeVisaCRMBundle:Customer')->find($id);
     ...
     * @Method("PUT")
     * @Template("MeVisaCRMBundle:Customer:edit.html.twig")
     */
