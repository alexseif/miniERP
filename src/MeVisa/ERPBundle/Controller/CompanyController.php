...
use MeVisa\ERPBundle\Entity\Company;
use MeVisa\ERPBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MeVisaERPBundle:Company')->findAll();
     ...
     * @Method("POST")
     * @Template("MeVisaERPBundle:Company:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MeVisaERPBundle:Company')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MeVisaERPBundle:Company:edit.html.twig")
     */
