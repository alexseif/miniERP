...
use MeVisa\ERPBundle\API\WCAPILogger;
...
class WCController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $entity->setHeader(json_encode($header));
...
//        $order = json_decode($content, true);
    ...
    public function showAction($id)
    {
        ...
        $entity->setContent(json_decode(json_decode($entity->getContent(), true), true));
